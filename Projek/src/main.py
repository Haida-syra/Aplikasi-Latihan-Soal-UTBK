...
class QuizApp(tk.Tk):
    ...
    def show_question(self):
            ...
            # Inisialisasi daftar radio agar tidak error AttributeError
            self.radio = [] 
            ...
            for i, c in enumerate(q.get("choices", [])):
                ...
                # PENTING: Menambahkan widget radio ke list agar fungsi next_step bisa mengaksesnya
